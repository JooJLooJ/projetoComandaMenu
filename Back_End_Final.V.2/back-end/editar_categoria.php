            ...
            <div class="col-4 order-last interface3">
                <div class="tamanho_interface3">
                    <div class="col coluna1">
                        ...
                        <p class='texto1'>Mesa</p>;

                    </div>

                    <div class="col coluna2">Sem itens no pedido</div>
                    <div class="col coluna3">Valor Total: R$ 0.00
                    </div>


                    <div class="col coluna4"><a href="mensagem.php">Realizar pedido</a></div>
                </div>
            </div>
